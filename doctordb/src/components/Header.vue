            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li v-bind:class="{activeFix: active == 'patient'}">
                        <a href="#" v-link="{path:'/patientmgr/list'}">患者</a>
                    </li>

                    <li v-privilege.literal="数据库-菜单-数据统计1">
                        <a href="javascript:">数据统计</a>
                    </li>
                    <li  v-privilege.literal="数据库-菜单-管理" v-bind:class="{activeFix: active == 'manager'}">
                        <a href="javascript:" v-link="{name:'manager'}"><span class="badge pull-right" style="background:red;">new</span>管理</a>
                    </li>
                    <li  v-privilege.literal="数据库-菜单-操作日志" v-bind:class="{activeFix: active == 'log'}">
                        <a href="javascript:" v-link="{name:'log'}">操作日志</a>
                    </li>
