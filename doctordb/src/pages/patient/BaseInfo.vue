<template>
                    ...
                    <tr id="baseinfohead" class="bg-F5F6FA">
                        <th colspan="6">基本信息
                            <template v-if="routepath == 'patient-baseinfo'">
                                <a v-privilege.literal="数据库-患者-修改" style="float: right;margin-right: 10px;" href="javascript:" v-link="{path:'/patient/'+patientid + '/modify/'}">基本信息修改</a>
                                <a  style="float: right;margin-right: 10px;" href="javascript:" @click.stop="clickBind" v-privilege.literal="数据库-患者-绑定微信">{{wxtitle}}</a>
                            </template>
                        </th>
                    </tr>
                    <tr>
    ...
    <div id="modal">
    <modal :show.sync="showModal" width="800px">
        <div slot="header">
