                ...
                <div class="bottom-dashed">
                    <div class="row padding-5px">
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <div class="col-lg-8 col-sm-8 clearPadding">
                                <input id="birthday" class="form-control" name="patient-birthday" type="text" @click="showCalendar" name="" v-model="patientinfo.birthday">
                ...
                <div class="bottom-dashed">
                    <div class="row padding-5px">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <div class="col-lg-8 col-sm-8 clearPadding">
                                <input name="patient-prcrid" class="form-control" type="text" name="" value="{{patientinfo.patientcardno}}" v-model="patientinfo.patientcardno">
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4">
                            <label class="col-lg-3 col-sm-3 clear-padding-left">患者ID</label>
                            <div class="col-lg-8 col-sm-8 clearPadding">
                                <input class="form-control" type="text" name="" value="{{patientinfo.patientcard_id}}" v-model="patientinfo.patientcard_id">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <div class="col-lg-11 col-sm-10">
                                    <div class="checkbox checkbox-inline checkbox-info">
                                        <input type="checkbox" id="value1" value="高血压" v-model="past_main_history_checkboxs" lazy>&nbsp;
                                        <label for="value1">高血压</label>
                                    </div>

                                    <div class="checkbox checkbox-inline checkbox-info">
                                        <input type="checkbox" id="value2" value="糖尿病" v-model="past_main_history_checkboxs" lazy>&nbsp;
                                        <label for="value2">糖尿病</label>
                                    </div>

                                    <div class="checkbox checkbox-inline checkbox-info">
                                        <input type="checkbox" id="value3" value="心脏病" v-model="past_main_history_checkboxs" lazy>&nbsp;
                                        <label for="value3">心脏病</label>
                                    </div>
                                    <div class="checkbox checkbox-inline checkbox-info">
                                        <input type="checkbox" id="value4" value="脑血管病" v-model="past_main_history_checkboxs" lazy>&nbsp;
                ...
                <div class="bottom-solid">
                    ...
                    <div v-show="patientinfo.smoke_history.first == '是'" class="row padding-5px">
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <div class="col-lg-11 col-sm-10">
                                <div class="checkbox checkbox-inline checkbox-info">
                                    <input type="checkbox" id="value5" value="二手" v-model="environment_touch_checkbox" lazy>&nbsp;<label for="value5">二手</label>
                                </div>
                                <div class="checkbox checkbox-inline checkbox-info">
                                    <input type="checkbox" id="value6" value="三手"  v-model="environment_touch_checkbox" lazy>&nbsp;<label for="value6">三手</label>
                                </div>
                                <div class="checkbox checkbox-inline checkbox-info">
                                    <input type="checkbox" id="value7" value="厨房油烟" v-model="environment_touch_checkbox" lazy>&nbsp;<label for="value7">厨房油烟</label>
                                </div>
                                <div class="checkbox checkbox-inline checkbox-info">
    ...
    methods: {
        ...
        setFamilyDiseases: function(data) {
            ...
            $.each(data, function(index, obj) {
                ...
                if (obj.disease == '癌症') {
                    that.family_history_contents.$set(0, obj.content);
                } else if (obj.disease == '遗传病史') {
                    that.family_history_contents.$set(1, obj.content);
                } else if (obj.disease == '其他') {
                    that.family_history_contents.$set(2, obj.content);
                }
            })
        },
