            ...
            <table class="table table-bordered margin-top-20px">
                    ...
                    <tr id="baseinfohead" class="bg-F5F6FA">
                        <th colspan="6">基本信息
                            <template v-if="routepath == 'patient-baseinfo-lungcancer'">
                                <a v-privilege.literal="数据库-患者-修改" style="float: right;margin-right: 10px;" href="javascript:" v-link="{path:'/patient/'+patientid + '/modify-lungcancer/'}">基本信息修改</a>
                ...
                <tr>
                    ...
                    <tr>
                        <td>详细情况</td>
                        <td colspan="5">
                            {{{patientInfo.family_history | filterFamilyHistory}}}
                        </td>
                    </tr>
                </tr>
                <tr>
