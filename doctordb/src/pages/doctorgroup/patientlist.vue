    ...
    <div class="container-fluid content">
        <div class="row" style="border-bottom: 1px solid #ccc">
            ...
            <ol class="breadcrumb" style="margin: 0">
                ...
                <li><a href="javascript:" v-link="{name: 'doctorgroup-centerlist', params:{'projectid': currentprojectid}}" style="text-decoration: none">中心列表</a></li>
                <li><a href="javascript:" v-link="{name: 'doctorgroup-centerdetail', params: {'projectid': currentprojectid, 'centerid': currentcenterid}}" style="text-decoration: none">中心详情</a></li>
            </ol> 
        </div>
        <div class="row">
