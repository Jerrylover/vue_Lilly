<template>
    ...
    <div class="container-fluid content">
        ...
        <modal :show.sync="showModal" :showHeader.sync='false' width="600px">
            <div slot="header"></div>
            <div slot="body">
        ...
        methods: {
            'addOrModifyProject': function(e) {
                ...
                if (self.title.trim() == '') {
                    ...
                    self.$dispatch('show-alert', self.alertError, function(){
                ...
                $.ajax({
                    ...
                    if (response.errno == 0) {
                        self.$dispatch('show-popup', '项目添加成功', function(){self.goProjectList();});
                    }else {
                        self.$dispatch('show-alert', response.errmsg);
                    }
                })
