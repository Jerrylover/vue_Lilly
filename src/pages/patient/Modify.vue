                ...
                <div class="bottom-dashed">
                    <div class="row padding-5px">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <div class="col-lg-8 col-sm-8 clearPadding">
                                <input name="out-case-no" class="form-control" type="text" v-model="patientinfo.out_case_no">
                ...
                <div class="bottom-dashed">
                    <div class="row padding-5px">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <div class="col-lg-8 col-sm-8 clearPadding">
                                <select class="form-control clearMargin" v-model="patientinfo.nation">
                ...
                <div class="bottom-dashed">
                    <div class="row padding-5px">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <div class="col-lg-8 col-sm-8 clearPadding">
                                <input name="patient-email" class="form-control" type="text" v-model="patientinfo.email">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bottom-solid">
                    <div class="row padding-5px">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <div class="col-lg-8 col-sm-8 clearPadding">
                                <input name="spare_contacts_mobile" class="form-control" type="text" v-model="patientinfo.other_contacts[0].mobile">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bottom-solid">
                    <div class="row padding-5px">
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <div class="col-lg-5 col-sm-6 clearPadding">
                                <textarea class="form-control" cols="50" rows="4" v-model="patientinfo.family_history"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-5 col-sm-7">
                                <div class="row" style="padding-left:15px;">
                                    <div class="col-lg-3 col-sm-3 clearPadding">
                                        <input class="form-control" type="text" v-model="menstruationHoldOnDays">
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-3 clearPadding">
                                        <input class="form-control" type="text" v-model="menstruationPeriod">
                                    </div>
                    ...
                    <div class="row padding-5px" v-if="menstruationStopStyle">
                        <div v-show="picked1 == '生理性'" class="col-lg-6 col-sm-6">
                            ...
                            <div class="col-lg-6 col-sm-7">
                                <input class="form-control" type="text" v-model="menstruationStopTime">
                            </div>
                ...
                <div>
                    <div class="row padding-5px">
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <div class="col-lg-5 col-sm-6 clearPadding">
                                <textarea class="form-control" cols="50" rows="4" v-model="patientinfo.allergy_history"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
