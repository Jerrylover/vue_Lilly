<template>
    <div>
        ...
        <modal :show.sync="showModal" width="300px">
            ...
            <div slot="body">
                <span style="">
                <i class="fa fa-info-circle" style="color:#42b983"></i>&nbsp;&nbsp;您的会话已过期，请重新登录
                </span>
        ...
        <alert :show.sync="showAlert" :msg="alertMsg" type="right"></alert>
...
module.exports = {
    ...
    events: {
        ...
        'e-changeNew': function(patientid, isnew) {
            this.$broadcast('n-changeNew', patientid, isnew);
        }
    }
}
</script>
