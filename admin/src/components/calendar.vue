<template>
    <div @click.stop="" @touchstart.stop="" class="calendar" v-show="show" :style="{'left':x+'px','top':y+'px'}" transition="calendar" transition-mode="out-in">
            ...
            <div class="text-center">
                <div class="div-year">
                    <div style="float:left">
                        <input type="text" v-model="year" @change="render(year,month)" min="1900" max="2200" maxlength="4" number>
                    </div>
        ...
        <div class="calendar-time" v-show="type=='datetime'||type=='time'">
            <div class="timer">
                <input type="number" v-model="hour" min="0" max="23" maxlength="2" number> 时
                <input type="number" v-model="minute" min="0" max="59" maxlength="2" number> 分
                <input type="number" v-model="second" min="0" max="59" maxlength="2" number> 秒
            </div>
        </div>
