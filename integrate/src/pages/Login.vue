    ...
    <div class="div-login">
        <form name="form1" method="post" action="/login/loginpost/" class="form-horizontal">
            ...
            <div class="form-group">
                <label for="username" class="col-lg-3 col-md-3 col-sm-3  control-label weight-normal">用户名</label>
            ...
            <div class="form-group">
                <label for="password" class="col-lg-3 col-md-3 col-sm-3 control-label weight-normal">密码</label>
                <div class="col-lg-8 col-md-8 col-sm-8">
            ...
            <div class="form-group">
                <div class="col-lg-offset-3 col-lg-8 col-md-8 col-md-offset-3 col-sm-8 col-sm-offset-3">
                    <button class="btn btn-success btn-block" @click="login($event)">登&nbsp;&nbsp;录</button>
                </div>
            </div>
        </form>
    </div>
